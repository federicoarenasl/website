...
A more detailed, step-by-step tutorial is available in two parts: [Part 1 — Generate data using Blender](/projects/fine-tune-detr-1) and [Part 2 — Fine-tune DETR](/projects/fine-tune-detr-2), this includes all code details for reproducibility.
...
The model generalizes to the target domain and reaches about mAP ≈ 0.67, with clear headroom via better data balance, diversity, and scene quality. I encourage you to try the [full two-part tutorial](/projects/fine-tune-detr-1) and to outperform this baseline — and to share what worked for you!
