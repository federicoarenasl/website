...
If you don't have these, you can go back to [**Part 1: Generate data using Blender**](/research/fine-tune-detr-1) where you'll be able to prepare your training and validation data.
